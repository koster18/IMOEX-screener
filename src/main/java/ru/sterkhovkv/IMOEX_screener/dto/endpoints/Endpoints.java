...
public class Endpoints {
    ...
    public static final String TIKER_REQUEST = "/iss/engines/stock/markets/shares/boards/TQBR/securities/";
    ...
    public static final String TIKER_REQUEST_PARAMS = ".json?iss.meta=off&marketdata.columns=LAST,MARKETPRICE&iss.version=on&iss.json=extended&securities.columns=SECID,SHORTNAME,LOTSIZE&dataversion.columns=data_version";
